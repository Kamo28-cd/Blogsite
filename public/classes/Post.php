<?php
class Post {
	public static function createPost($postbody, $loggedInUserId, $profileUserId, $subject, $grade) {
					...
					if ($loggedInUserId == $profileUserId) {
						...
						DB::query('INSERT INTO posts VALUES (\'\', :postbody, NOW(), :userid, 0, :subject, :grade, \'\', \'0\')', array(':postbody'=>$postbody, ':userid'=>$profileUserId, ':subject'=>$subject, ':grade'=>$grade));
					} else {
							die('Incorrect User');
						}
		}
		
		public static function createImgPost($postbody, $loggedInUserId, $profileUserId, $subject, $grade) {
